...
```{r extract-worldclim-dummy, fig.width=4, fig.height=3, fig.align='center', eval=FALSE}
d <- extract(climate, p, ID = FALSE, cell = TRUE, xy = TRUE)
```

```{r extract-worldclim, fig.width=4, fig.height=3, fig.align='center', echo=FALSE}
ff <- list.files(
  "../data",         # where the files are
  pattern = "wc2.1", # wc = WorldClim
  full.names = TRUE  # full path
