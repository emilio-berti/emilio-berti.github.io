...
{\bf Programming} R (expert), python (expert), bash (expert), C/C++ (advanced), Stan (advanced), javascript (mostly for Google Earth Engine, proficient), SQL (postgres flavor; advanced), GIS (expert), High Performance Computing (expert)\\
